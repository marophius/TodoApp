...
namespace TodoApp.Uranium.ViewModels
{
    public partial class MainPageViewModel : ObservableObject
    {
        ...
        {
            await Shell.Current.GoToAsync("create-todo");
        }
        ...
        private void TextChangedToSearch()
        {
            OverdueTodoList = _todos
                                        .Where(t => t.Name.ToLower().Contains(TextSearch.ToLower()) && t.PrevisionDate <= DateOnly.FromDateTime(DateTime.Now.AddDays(-1)) && !t.Status)
                                        .ToList();
